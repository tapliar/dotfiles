# Generated by Powerlevel10k configuration wizard on 2022-12-17 at 13:58 GMT.
...
() {
  ...
  function my_git_formatter() {
    ...
    # Display "wip" if the latest commit's summary contains "wip", "WIP", "draft" or "Draft".
    if [[ $VCS_STATUS_COMMIT_SUMMARY == (|*[^[:alnum:]])(wip|WIP|draft|Draft)(|[^[:alnum:]]*) ]]; then
      res+=" ${modified}wip"
    fi
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND='#FFD43B'
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND='#FFD43B'
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND='#306998'
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND='#6AD7E3'
